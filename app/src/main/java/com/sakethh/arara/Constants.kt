...
object Constants {
    ...
    const val SUBREDDIT_FANARTS_TOP_ALL_TIME="$SUBREDDIT/fanarts/topAllTime"
    const val SUBREDDIT_IMAGES_Relevance="$SUBREDDIT/image/relevance"
    const val SUBREDDIT_IMAGES_TOP_ALL_TIME="$SUBREDDIT/image/topAllTime"
    const val SUBREDDIT_NEWS_Relevance="$SUBREDDIT/news/relevance"
    const val SUBREDDIT_NEWS_TOP_ALL_TIME="$SUBREDDIT/news/topAllTime"
